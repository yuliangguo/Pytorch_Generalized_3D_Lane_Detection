                ...
                for j in range(num_el):
                    ...
                    if vis_feat:
                        ...
                        if args1.no_3d:
                            ...
                            img1 = vs_saver1.draw_on_img(img1, gt[j], M2, 'laneline', color=[0, 0, 1])
                    ...
                    if 'tusimple' in args1.dataset_name:
                        ...
                        lane_anchor_short = np.concatenate((lane_anchors[:, 0:args1.num_y_steps],
                                                            lane_anchors[:, 2*args1.num_y_steps].reshape(-1, 1)), axis=1)
...
if __name__ == '__main__':
    ...
    num_class = 7
    geo_model_dir = 'Model_3DLaneNet_2stage_7class_crit_loss_3D_opt_adam_lr_0.0005_batch_8_360X480_pretrain_False_batchnorm_True_predcam_False'
    ...
    args2.mod = '3DLaneNet_2stage_7class'
    ...
    model2 = LaneNet3D_GeoOnly.Net(args2, input_dim=num_class-1, debug=True)
