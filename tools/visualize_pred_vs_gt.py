...
class lane_visualizer(object):
    ...
    def visualize_lanes(self, gt_lanes, pred_lanes, raw_file, gt_cam_height, gt_cam_pitch, ax1, ax2, ax3):
...
if __name__ == '__main__':
    ...
    for i, pred in enumerate(json_pred):
        ...
        # draw lanes
        vs.visualize_lanes(gt_lanelines, pred_lanelines, raw_file, gt_cam_height, gt_cam_pitch, ax1, ax2, ax3)
        vs.visualize_lanes(gt_centerlines, pred_centerlines, raw_file, gt_cam_height, gt_cam_pitch, ax4, ax5, ax6)
        ax1.set_xticks([])
        ax1.set_yticks([])
        ax2.set_xticks([])
        ax2.set_yticks([])
