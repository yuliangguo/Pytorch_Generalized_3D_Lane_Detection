"""
Batch test code for 3D-LaneNet with new anchor extension. It predicts 3D lanes from a single image.
...
if __name__ == '__main__':
    ...
    args.mod = '3D_LaneNet_ext'  # model name
    ...
    # Define network
    model = LaneNet3D_ext.Net(args, debug=vis_feat)
